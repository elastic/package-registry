...
func TestEndpoints(t *testing.T) {
	...
	tests := []struct {
		...
		{"/categories?spec.min=1.1.0&spec.max=2.10.0&prerelease=true", "/categories", "categories-spec-min-max-2.10.0.json", categoriesHandler(testLogger, indexer, testCacheTime)},
		{"/categories?spec.max=3.1.0&prerelease=true", "/categories", "categories-spec-default-min-max-3.1.0.json", categoriesHandler(testLogger, indexer, testCacheTime)},
