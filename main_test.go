...
func TestArtifacts(t *testing.T) {
	...
	indexer := packages.NewFileSystemIndexer(testLogger, nil, false, packagesBasePaths...)
	t.Cleanup(func() { indexer.Close(context.Background()) })
...
func TestSignatures(t *testing.T) {
	...
	indexer := packages.NewZipFileSystemIndexer(testLogger, nil, false, "./testdata/local-storage")
	t.Cleanup(func() { indexer.Close(context.Background()) })
...
func TestStaticsModifiedTime(t *testing.T) {
	...
	indexer := NewCombinedIndexer(
		packages.NewZipFileSystemIndexer(testLogger, nil, false, "./testdata/local-storage"),
		packages.NewFileSystemIndexer(testLogger, nil, false, "./testdata/package"),
	)
	t.Cleanup(func() { indexer.Close(context.Background()) })
...
func TestZippedPackageIndex(t *testing.T) {
	...
	indexer := packages.NewZipFileSystemIndexer(testLogger, nil, false, packagesBasePaths...)
	t.Cleanup(func() { indexer.Close(context.Background()) })
