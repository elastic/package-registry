...
func TestEndpoints(t *testing.T) {
	...
	tests := []struct {
		...
		{"/categories?kibana.version=7.16.0&kibana.version=8.0.0", "/categories", "categories-kibana-7160-or-800.json", categoriesHandler(indexer, testCacheTime)},
		...
		{"/search?kibana.version=7.16.0&kibana.version=8.0.0", "/search", "search-kibana-7160-or-800.json", searchHandler(indexer, testCacheTime)},
